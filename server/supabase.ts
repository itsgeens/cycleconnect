...
console.log('DEBUG: Checking Supabase env vars...'); // Add this
console.log('DEBUG: supabaseUrl:', supabaseUrl);       // Add this
console.log('DEBUG: supabaseKey:', supabaseServiceRoleKey);       // Add this
